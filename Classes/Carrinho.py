...
class Carrinho:
    ...
    def salvar(self):
        ...
        with open("banco/carrinho.txt") as dados_banco:
        ...
        # Adiciona um novo registro:
            ...
            if num_linhas >= 1:
                dados_banco.writelines(f"\n{self.codigo};{self.codigo_produto};{self.quantidade}")
            else:
                dados_banco.writelines(f"{self.codigo};{self.codigo_produto};{self.quantidade}")
